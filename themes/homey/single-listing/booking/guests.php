...
<div class="search-guests single-guests-js">
	<input name="guests" value="<?php echo esc_attr($guest_val2); ?>" readonly type="text" class="form-control" autocomplete="off" placeholder="<?php echo esc_html__('Fan type','homey'); //esc_attr(homey_option('srh_guests_label')); ?>">
	...
	<div class="search-guests-wrap single-form-guests-js clearfix">
		...
		<div class="adults-calculator">
			...
			<span class="calculator-label"><?php echo esc_html__('Cooling fan','homey'); //esc_attr(homey_option('srh_adults_label')); ?></span>
		...
		<div class="children-calculator">
			...
			<span class="calculator-label"><?php echo esc_html__('Industrial fan','homey'); //echo esc_attr(homey_option('srh_child_label')); ?></span>
