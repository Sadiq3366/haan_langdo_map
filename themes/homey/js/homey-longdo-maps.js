(function($){
    ...
    if ( typeof HOMEY_map_vars !== "undefined" ) {
        ...
        //     { lon: 100.523186, lat: 13.736717 },
        //     {
        //       icon: {
        //         url: 'path/to/marker-icon.png', // Replace with the path to your marker icon
        //         offset: { x: 16, y: 32 } // Adjust the icon's offset if needed
        //       }
        //     }
        //   );
        
        //   var infobox = new longdo.Popup({ lon: 99, lat: 14 },
        //             {
        //             title: 'Popup',
        //             detail: 'Simple popup',
        //             maxWidth: 300,
        ...
        //     alignBottom: true,
        //     disableAutoPan: false,
        //     pixelOffset: new longdo.maps.Size(-160, infobox_top),
        //     zIndex: null,
        //     boxClass: 'homeyInfobox',
        //     closeBoxMargin: "13px 2px -14px 2px",
        //     closeBoxURL: infoboxClose,
        //     infoBoxClearance: new longdo.maps.Size(20, 20),
        //     pane: "floatPane",
        //     enableEventPropagation: false,
        // });
        ...
        //     longdo.maps.event.addListener(homeyMap, 'tilesloaded', function() {
        //         jQuery('#homey-map-loading').hide();
        //     });
        // }
        ...
        //             homeyMap . Event . bind ( 'click' , function () 
        //             {
        //                 var mouseLocation = homeyMap . location ( longdo . LocationMode . Pointer ); 
        //                 homeyMap . Overlays . add ( new longdo . Marker ( mouseLocation )) ;  
        //             });                      
        ...
        var homey_markerCluster = function(homeyMap) {
            ...
            if(pin_cluster == 'yes') {
                ...
                var markercluster ; var limit = 4000 ;  
          
                markercluster = new lmc . MarkerCluster ( homeyMap ,{});     
                
                var loc = homeyMap . location (); while ( limit --)
                {
        ...
        //     longdo.maps.event.addDomListener(document.getElementById('listing-mapzoomin'), 'click', function () {
        ...
        //     longdo.maps.event.addDomListener(document.getElementById('listing-mapzoomout'), 'click', function () {
        //         var current= parseInt( homeyMap.getZoom(),10);
        //         console.log(current);
        //         current--;
        //         if(current < 0){
        ...
        //     if(map_type==='roadmap'){
        //         homeyMap.setMapTypeId(longdo.maps.MapTypeId.ROADMAP);
        //     }else if(map_type==='satellite'){
        //         homeyMap.setMapTypeId(longdo.maps.MapTypeId.SATELLITE);
        //     }else if(map_type==='hybrid'){
        //         homeyMap.setMapTypeId(longdo.maps.MapTypeId.HYBRID);
        //     }else if(map_type==='terrain'){
        //         homeyMap.setMapTypeId(longdo.maps.MapTypeId.TERRAIN);
        //     }
        //     return false;
        // }
        ...
        //     longdo.maps.event.trigger( markers[current_marker-1], 'click' );
        ...
        var homey_map_search_field = function (mapInput, homeyMap) {
            ...
            var searchBox = new longdo.maps.places.SearchBox(mapInput);
            homeyMap.controls[longdo.maps.ControlPosition.TOP_LEFT].push(mapInput);
            ...
            searchBox.addListener('places_changed', function() {
                ...
                var bounds = new longdo.maps.LatLngBounds();
                places.forEach(function(place) {
                    var icon = {
                        url: place.icon,
                        size: new longdo.maps.Size(71, 71),
                        origin: new longdo.maps.Point(0, 0),
                        anchor: new longdo.maps.Point(17, 34),
                        scaledSize: new longdo.maps.Size(25, 25)
                    };

                    // Create a marker for each place.
                    markers_location.push(new longdo.maps.Marker({
                        map: homeyMap,
                        icon: icon,
                        title: place.name,
        ...
        var homeyAddMarker = function( props, map ) {
            ...
            $.each(props, function(i, prop) {
                ...
                if( markerPricePins == 'yes' ) {
                    ...
                    var marker = new longdo . Marker ({ lon : prop.long , lat : prop.lat }, { 
                        title : 'Custom Marker' , 
                        icon : { 
                            url : 'https://map.longdo.com/mmmap/images/pin_mark.png' , 
                            offset : { x : 12 , y : 45 } 
                        }, 
                        visibleRange : { min : 0 , max : 900 }, 
                        draggable : true , 
                        flat: true,
                        popup : { 
                          html : pricePin
                    ...
                    var marker_size = new map.Size( 44, 56 );
                    if( window.devicePixelRatio > 1.5 ) {
                        if ( prop.retinaIcon ) {
                            marker_url = prop.retinaIcon;
                            marker_size = new map.Size( 44, 56 );
                        }
                    }
                    ...
                    var marker_icon = {
                        url: marker_url,
                        size: marker_size,
                        scaledSize: new map.Size( 44, 56 ),
                    };

                    var marker = new longdo.maps.Marker({
                        position: latlng,
                        map: map,
                        icon: marker_icon,
                        draggable: false,
                ...
                var infoboxContent = '<div id="google-maps-info-window">'+
                    ...
                    // longdo.maps.event.addListener(marker, "click", function (e) {
        ...
        var homeyMainMap = function(_lat, _long, element, markerTarget, showMarkerLabels, defaultZoom, optimizedMapLoading, isHalfMap, halfMapAjaxData, maptype) {
            ...
            if( document.getElementById(element) != null ) {
                ...
                var homeyMap = new longdo.Map({
                    placeholder: document.getElementById(element),
                ...
                homeyMap . Event . bind('ready', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if(data.getListings === true) {
                                ...
                                //homeyMap.setCenter(new longdo.maps.LatLng(default_lat, default_lng));
                                homeyMap . location ({ lon : default_lng , lat : default_lat }, true );
                                $('#homey-map-loading').hide();
                ...
                //     }, new longdo.LatLngBounds()));

                //     var current = parseInt( homeyMap.getZoom(),10);
                //     if(current > 20){
                //         current = 14;
                //     }
                //     homeyMap.Zoom(current);
                // }
        ...
        var homeySimpleMap = function (_lat, _long, element, markerDragable, showCircle, defaultZoom, marker_pin, marker_pin_retina) {
            ...
            var homeySimpleMarker = function(homeyMap) {
                ...
                var marker_icon = {
                    url: marker_url,
                    size: marker_size,
                    scaledSize: new longdo.maps.Size( 44, 56 ),
                };
                ...
                var marker = new longdo.maps.Marker({
                    ...
                    icon: marker_icon,
                    draggable: false,
                    animation: longdo.maps.Animation.DROP,
                });
            }

            var homeyCircle = function(homeyMap) {
                var Circle = new longdo.maps.Circle({
                    strokeColor: '#4f5962',
                    strokeOpacity: 0.8,
                    strokeWeight: 2,
                    fillColor: '#4f5962',
            ...
            mapCenter = new longdo.maps.LatLng(_lat, _long);
            var drawMap = function(mapCenter){
                ...
                homeyMap = new longdo.maps.Map(mapElement, mapOptions);
        ...
        *-------------------------------------------------------------------------------------*/
        var homeyStickyMap = function(element, showMarkerLabels, defaultZoom, mapPaged) {
            ...
            if( document.getElementById(element) != null ) {
                ...
                homeyMap = new longdo.maps.Map(document.getElementById(element), {
                    zoom: defaultZoom,
                    zoomControl: false,
                    ...
                    fullscreenControlOptions: {
                        position: longdo.maps.ControlPosition.RIGHT_BOTTOM
                    },
                    center: new longdo.maps.LatLng(_lat, _long),
                    mapTypeId: "roadmap",
                    gestureHandling: 'cooperative',
                    styles: google_map_style,
                });
                ...
                longdo.maps.event.addListenerOnce(homeyMap, 'idle', function(){
                    loadMapData(ajaxurl, ajaxData);
                });
       ...
       *---------------------------------------------------------------------------*/
        if (document.getElementById('location_search')) {
            ...
            defaultBounds = new longdo.maps.LatLngBounds(
                new longdo.maps.LatLng(-90, -180),
                new longdo.maps.LatLng(90, 180)
            );
            var options = {
            ...
            autocomplete_main_search = new longdo.maps.places.Autocomplete(inputField, options);
            ...
            longdo.maps.event.addListener(autocomplete_main_search, 'place_changed', function () {
        ...
        if (document.getElementById('location_search_mobile')) {
            ...
            defaultBounds_m = new longdo.maps.LatLngBounds(
                new longdo.maps.LatLng(-90, -180),
                new longdo.maps.LatLng(90, 180)
            );
            var options_m = {
            ...
            autocomplete_mobile_search = new longdo.maps.places.Autocomplete(inputField_m, options_m);
            ...
            longdo.maps.event.addListener(autocomplete_mobile_search, 'place_changed', function () {
        ...
        if (document.getElementById('location_search_banner')) {
            ...
            defaultBounds_2 = new longdo.maps.LatLngBounds(
                new longdo.maps.LatLng(-90, -180),
                new longdo.maps.LatLng(90, 180)
            );
            var options_2 = {
            ...
            autocomplete_banner_search = new longdo.maps.places.Autocomplete(inputField_2, options_2);
            ...
            longdo.maps.event.addListener(autocomplete_banner_search, 'place_changed', function () {
        ...
        function fillInAddress_main_search(place) {
            ...
            //var latLng = new longdo.maps.LatLng( place.geometry.location.lat(), place.geometry.location.lng() );
