                    ...
                    switch($key) { 
                        case 'location':
                            ...
                            <div class="<?php echo esc_attr($location_classes); ?>">
                                ...
                                <input name="location_search" autocomplete="off" id="location_search_mobile" value="<?php echo esc_attr($location_search); ?>" type="text" class="form-control input-search" placeholder="<?php echo esc_html__('Choose Province','homey'); //echo esc_attr(homey_option('srh_whr_to_go')); ?>">
                        ...
                        case 'arrive_depart':
                            ...
                            <div class="search-date-range main-search-date-range-js">
                                <div class="search-date-range-arrive">
                                    ...
                                    <input name="arrive" autocomplete="off" value="<?php echo esc_attr($arrive); ?>" readonly type="text" class="form-control" placeholder="<?php echo esc_html__('From','homey'); //esc_attr(homey_option('srh_arrive_label')); ?>">
                                </div>
                                <div class="search-date-range-depart">
                                    <label class="animated-label"><?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?></label>
                                    <input name="depart" autocomplete="off" value="<?php echo esc_attr($depart); ?>" readonly type="text" class="form-control" placeholder="<?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?>">
                                </div>
                                <?php 
                        ...
                        case 'listing_type':
                            ...
                            <div class="search-type">
                                <select name="listing_type" class="selectpicker" data-live-search="false">
                                    <?php
                                    // All Option
                                    echo '<option value="">'.esc_html__('Fan`s','homey').'</option>';
