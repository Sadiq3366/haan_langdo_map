                ...
                switch($key) { 
                    case 'location':
                        ...
                        <div class="<?php echo esc_attr($location_classes).' '.esc_attr($radius_class); ?>">
                            ...
                            <label class="animated-label"><?php echo esc_html__('Choose Province','homey'); ?></label>    
                            <input type="text" name="location_search" autocomplete="off" id="location_search_banner" value="<?php echo esc_attr($location_search); ?>" class="form-control input-search" placeholder="<?php echo esc_html__('Choose Province','homey'); //esc_attr(homey_option('srh_whr_to_go')); ?>">
                            ...
                            <?php } elseif($location_field == 'keyword') { ?>
                                        ...
                                        <label class="animated-label"><?php echo esc_html__('Choose Province','homey'); //esc_attr(homey_option('srh_whr_to_go')); ?></label>
                                ...
                                <?php
                                // All Option
                                echo '<option value="">'.esc_html__('Choose Province','homey');//esc_html__(esc_attr(homey_option('srh_whr_to_go')),'homey').'</option>';
                            ...
                            <?php
                            // All Option
                            echo '<option value="">'.esc_html__('Choose Province','homey'); //esc_attr(homey_option('srh_whr_to_go')).'</option>';
                    ...
                    case 'arrive_depart':
                    	...
                    	<div class="search-date-range main-search-date-range-js">
							<div class="search-date-range-arrive">
								<label class="animated-label"><?php echo esc_html__('From','homey'); //esc_attr(homey_option('srh_arrive_label')); ?></label>
								<input type="text" autocomplete="off" name="arrive" value="<?php echo esc_attr($arrive); ?>" class="form-control" placeholder="<?php echo esc_html__('From','homey'); //esc_attr(homey_option('srh_arrive_label')); ?>">
							</div>
							<div class="search-date-range-depart">
								<label class="animated-label"><?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?></label>
								<input type="text" autocomplete="off" name="depart" value="<?php echo esc_attr($depart); ?>" class="form-control" placeholder="<?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?>">
							</div>
                    ...
                    case 'listing_type':
                    	...
                    	<div class="search-type">
                        	<select name="listing_type" class="selectpicker" data-live-search="false">
                                <?php
                                // All Option
                                echo '<option value="">'.esc_html__('Fan`s type','homey').'</option>';
