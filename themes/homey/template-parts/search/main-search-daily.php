                        ...
                        switch($key) { 
                            case 'location':
                                ...
                                <div class="<?php echo esc_attr($location_classes).' '.esc_attr($radius_class); ?>">
		                            ...
		                            <?php
		                            // All Option
		                            echo '<option value="">'.esc_html__('Choose Province','homey'); //sanitize_text_field(homey_option('srh_whr_to_go')).'</option>';
                            ...
                            case 'arrive_depart':
                            	...
                            	<div class="search-date-range main-search-date-range-js">
									<div class="search-date-range-arrive">
										...
										<input name="arrive" autocomplete="off" value="<?php echo esc_attr($arrive); ?>" type="text" class="form-control" placeholder="<?php echo esc_html__('From','homey'); //esc_attr(homey_option('srh_arrive_label')); ?>">
									</div>
									<div class="search-date-range-depart">
										<label class="animated-label"><?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?></label>
										<input name="depart" autocomplete="off" value="<?php echo esc_attr($depart); ?>" type="text" class="form-control" placeholder="<?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?>">
									</div>
