                    ...
                    case 'arrive_depart':
                    	...
                    	<div class="search-date-range main-search-date-range-js clearfix">
							<div class="search-date-range-arrive">
								...
								<input type="text" name="arrive" autocomplete="off" value="<?php echo esc_attr($arrive); ?>" class="form-control" placeholder="<?php echo esc_html__('From','homey'); //esc_attr(homey_option('srh_arrive_label')); ?>">
							</div>
							<div class="search-date-range-depart">
								<label class="animated-label"><?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?></label>
								<input type="text" name="depart" autocomplete="off" value="<?php echo esc_attr($depart); ?>" class="form-control" placeholder="<?php echo esc_html__('To','homey'); //esc_attr(homey_option('srh_depart_label')); ?>">
							</div>
