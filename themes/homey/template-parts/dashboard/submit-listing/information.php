            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="listing_type[]" multiple class="selectpicker" id="listing_type" <?php homey_required('listing_type'); ?> data-live-search="false" data-live-search-style="begins">
