...
<div id="pricing-tab" class="tab-pane fade <?php echo esc_attr($class);?>">
    ...
    <div class="block-body">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <label><?php echo esc_html__('over distance fee','homey'); //esc_attr(homey_option('ad_cleaning_fee')); ?></label>
            </div>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <input type="text" name="cleaning_fee" value="<?php echo esc_attr($cleaning_fee); ?>" class="form-control" placeholder="<?php echo esc_html__('Enter over distance fee'); //esc_attr(homey_option('ad_cleaning_fee_plac')); ?>">
                </div>
            </div>
            <div class="col-sm-3 col-xs-6">
                <div class="form-group">
            ...
            <div class="col-sm-3 col-xs-6">
                <div class="form-group">
                    <label class="control control--radio radio-tab">
                        ...
                        <span class="control-text"><?php echo esc_html__('hourly','homey'); //esc_attr(homey_option('ad_perstay_text')); ?></span>
                        <span class="control__indicator"></span>
                        <span class="radio-tab-inner"></span>
                    </label>
                </div>
