...
$provience         = get_post_meta( get_the_ID(), $homey_prefix.'provience', true );
        ...
        <div class="media-body item-body clearfix">
            <div class="item-title-head table-block">
                <div class="title-head-left">
                    ...
                    <?php echo $provience;  //the_title(); ?></a></h2>
                    <?php 
                    if(!empty($address)) {
            ...
            <ul class="item-amenities">
                    ...
                    <?php 
                        homey_get_taxonomies_for_type_value(get_the_ID(),'listing_type');
                    ?>

            </ul>

            <?php if(1==2) { if($cgl_meta != 0) { ?>
            <ul class="item-amenities">
